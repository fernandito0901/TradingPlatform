...
- [T47] Archive dated plans · Acceptance: consolidated summary saved to `planning/archive.md` and original files removed · Assignee: Planner
- [T48] Create numbered plan index · Acceptance: `design/plans/index.md` lists all `P***.md` files in order · Assignee: Planner
- [T49] Refresh documentation for numbered plans · Acceptance: README and PLAN_INDEX reference `design/plans/` · Assignee: Reviewer
...
- [T46] Update references for new planning layout · Acceptance: README and automation scripts point to numbered plans · Completed by Coder on 2025-08-14
