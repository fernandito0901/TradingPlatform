...
- Scheduler service entrypoint added under `services/scheduler/app.py`
- New `validate_env` utility ensures required variables are set
- AGENTS guidelines require task IDs in commit messages
- Delayed stream reconnects with exponential backoff
